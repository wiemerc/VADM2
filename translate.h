...
static const uint8_t testcase_tbl[][2][MAX_OPCODE_SIZE + 1] = {
    ...
    {{6, 0x23, 0xc0, 0xde, 0xad, 0xbe, 0xef},              {8, 0x44, 0x89, 0x04, 0x25, 0xef, 0xbe, 0xad, 0xde}},    // move.l d0, 0xdeadbeef => mov [0xdeadbeef], r8d
    {{6, 0x22, 0x3c, 0xde, 0xad, 0xbe, 0xef},              {6, 0x41, 0xb9, 0xef, 0xbe, 0xad, 0xde}},                // move.l d0, 0xdeadbeef => mov [0xdeadbeef], r8d
};
#endif
