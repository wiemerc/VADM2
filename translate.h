...
static const uint8_t testcase_tbl[][2][MAX_OPCODE_SIZE + 1] = {
    ...
    {{4, 0x2c, 0x78, 0x00, 0x04},						   {8, 0x48, 0x8b, 0x34, 0x25, 0x04, 0x00, 0x00, 0x00}},	// movea.l 0x0004, a6 => mov rsi, [0x00000004]
    {{4, 0x28, 0x79, 0xde, 0xad, 0xbe, 0xef},			   {8, 0x48, 0x8b, 0x3c, 0x25, 0xef, 0xbe, 0xad, 0xde}},	// movea.l 0xdeadbeef, a4 => mov rdi, [0xdeadbeef]
    {{4, 0x2e, 0x79, 0xde, 0xad, 0xbe, 0xef},			   {8, 0x48, 0x8b, 0x24, 0x25, 0xef, 0xbe, 0xad, 0xde}},	// movea.l 0xdeadbeef, a7 => mov rsp, [0xdeadbeef]
};
#endif
