...
static const uint8_t testcase_tbl[][2][MAX_OPCODE_SIZE + 1] = {
    ...
    {{6, 0x20, 0x39, 0x55, 0x55, 0xaa, 0xaa},              {8, 0x44, 0x8b, 0x04, 0x25, 0xaa, 0xaa, 0x55, 0x55}},    // move 0x5555aaaa, d0 => mov r8d, [0x5555aaaa]
    {{6, 0x22, 0x3c, 0x55, 0x55, 0xaa, 0xaa},              {6, 0x41, 0xb9, 0xaa, 0xaa, 0x55, 0x55}},                // move #0x5555aaaa, d1 => mov r9d, 0x5555aaaa
    {{6, 0x23, 0xc1, 0x55, 0x55, 0xaa, 0xaa},              {8, 0x44, 0x89, 0x0c, 0x25, 0xaa, 0xaa, 0x55, 0x55}},    // move d1, 0x5555aaaa => mov [0x5555aaaa], r9d
    {{2, 0x26, 0x02},                                      {3, 0x45, 0x89, 0xd3}},                                  // move d2, d3 => mov r11d, r10d
};
#endif
